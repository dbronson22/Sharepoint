(function(k){k.fn.weatherfeed=function(q,f,x){f=k.extend({unit:"f",image:!0,country:!1,highlow:!0,wind:!0,humidity:!1,visibility:!1,sunrise:!1,sunset:!1,forecast:!1,forecastdays:5,link:!0,showerror:!0,linktarget:"_self",woeid:!1,refresh:0},f);var m="odd";return this.each(function(p,t){function y(f,c,e){m="odd";g.html("");k.ajax({type:"GET",url:c,dataType:"json",success:function(a){if(a.query){if(0<a.query.results.channel.length)for(var c=a.query.results.channel.length,b=0;b<c;b++)z(t,a.query.results.channel[b],
